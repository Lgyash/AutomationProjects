...
public class BestSellersTestcases {
WebDriver driver = new ChromeDriver();
	
	@BeforeMethod
	public void Basic() {
		System.setProperty("webdriver.chrome.driver","E:\\Work\\chromedriver.exe");
        String baseUrl = "http://automationpractice.com/index.php?controller=best-sales";
        driver.get(baseUrl);
	}
	...
	public void TestTheSortByMethod() {
			...
			driver.findElement(By.cssSelector("body.best-sales.hide-right-column.lang_en:nth-child(2) div.columns-container div.container div.row:nth-child(3) div.center_column.col-xs-12.col-sm-9 div.content_sortPagiBar:nth-child(2) div.sortPagiBar.clearfix form.productsSortForm div.select.selector1 div.selector:nth-child(2) select.selectProductSort.form-control:nth-child(2) > option:nth-child(1)")).click();
	}
	...
	public void WhenTheUserClickOnMoreButtonOnAnyProductItOpensProductPage() {
		driver.findElement(By.cssSelector("body.best-sales.hide-right-column.lang_en:nth-child(2) div.columns-container div.container div.row:nth-child(3) div.center_column.col-xs-12.col-sm-9 ul.product_list.grid.row:nth-child(3) li.ajax_block_product.col-xs-12.col-sm-6.col-md-4.first-in-line.first-item-of-tablet-line.first-item-of-mobile-line.hovered:nth-child(1) div.product-container div.right-block div.button-container:nth-child(4) a.button.lnk_view.btn.btn-default:nth-child(2) > span:nth-child(1)")).click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		String url = driver.getCurrentUrl();
		Assert.assertEquals("http://automationpractice.com/index.php?id_product=5&controller=product",url);
	}
	
	@Test(priority = 6)
	public void WhenTheUserClickOnQuickViewItShouldNavigatesHimToSubWindowProduct() {
		driver.findElement(By.cssSelector("body.best-sales.hide-right-column.lang_en:nth-child(2) div.columns-container div.container div.row:nth-child(3) div.center_column.col-xs-12.col-sm-9 ul.product_list.grid.row:nth-child(3) li.ajax_block_product.col-xs-12.col-sm-6.col-md-4.first-in-line.first-item-of-tablet-line.first-item-of-mobile-line.hovered:nth-child(1) div.product-container div.left-block div.product-image-container a.quick-view > span:nth-child(1)")).click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
