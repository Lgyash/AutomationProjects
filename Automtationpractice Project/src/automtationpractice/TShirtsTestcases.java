...
WebDriver driver = new ChromeDriver();
	...
	public void ChangeTheViewOfTheProducts() {
		driver.findElement(By.cssSelector("body.category.category-5.category-tshirts.hide-right-column.lang_en:nth-child(2) div.columns-container div.container div.row:nth-child(3) div.center_column.col-xs-12.col-sm-9 div.content_sortPagiBar.clearfix:nth-child(3) div.sortPagiBar.clearfix ul.display.hidden-xs li:nth-child(3) a:nth-child(1) > i.icon-th-list")).click();
	...
	public void WhenTheUserClickOnMoreButtonOnAnyProductItOpensProductPage() {
		...
		Assert.assertEquals("http://automationpractice.com/index.php?id_product=1&controller=product",url);
	}
	
	@Test(priority = 11)
	public void WhenTheUserClickOnQuickViewItShouldNavigatesHimToSubWindowProduct() {
		driver.findElement(By.cssSelector("body.category.category-5.category-tshirts.hide-right-column.lang_en:nth-child(2) div.columns-container div.container div.row:nth-child(3) div.center_column.col-xs-12.col-sm-9 ul.product_list.grid.row:nth-child(4) li.ajax_block_product.col-xs-12.col-sm-6.col-md-4.first-in-line.last-line.first-item-of-tablet-line.first-item-of-mobile-line.last-mobile-line.hovered div.product-container div.left-block div.product-image-container a.quick-view > span:nth-child(1)")).click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		Boolean Product = driver.findElement(By.id("product")).isDisplayed();
		Assert.assertTrue(Product);
	}
